                    ...
                    <xsl:otherwise>
                        <table width="100%" >
                            <tr>
                                ...
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/delbt/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/delhier/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/relevanthier/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
