                    ...
                    <xsl:otherwise>
                        <table width="100%" >
                            <tr>
                                ...
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/kind/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/oldname/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/newname/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/newnameexists/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
