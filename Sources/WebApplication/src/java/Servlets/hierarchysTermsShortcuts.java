            ...
            //</editor-fold>
                ...
                */
                ...
                writeHierarchicalResultsInXMLFile(allHierTermsVec, ntsOfHierDesciptor, hierarchy, u,
                        time, 
                        "<typicalHierarchicalLocation>"+typicalLocation+"</typicalHierarchicalLocation><treeHierarchicalLocation>"+treeLocation+"</treeHierarchicalLocation><base>Ιεραρχική παρουσίαση όρων της ιεραρχίας: </base><arg1>" + Utilities.escapeXML(hierarchy) + "</arg1>",/* xslLink,*/ webAppSaveResults_temporary_filesAbsolutePath + "/" + Save_Results_file_name1 + ".xml",pathToSaveScriptingAndLocale, targetLocale);
