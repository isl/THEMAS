...
----------------------------------------------------------------------*/
public class StartExportImportToXML extends ApplicationBasicServlet {
    /*---------------------------------------------------------------------
                                    doGet()
    ----------------------------------------------------------------------*/                
	...
	request.setCharacterEncoding("UTF-8");
        ...
        try{
            ...
            task.performScheduledBackupActions("Backup_Before_DB_Reset");
            ...
            //ScheduledBackups task = new ScheduledBackups(request,sessionInstance, pathToErrorsXML, language, country);
            //task.performScheduledBackupActions();
            ...
            if (action != null) {
                if (action.compareTo("LOCK") == 0) {
                    if (Parameters.SYSTEM_IS_LOCKED == false) {
                        // ---------------------- LOCK SYSTEM ----------------------
