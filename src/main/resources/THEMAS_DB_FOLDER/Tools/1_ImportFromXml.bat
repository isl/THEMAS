...
"%JAVA_BIN_PATH%\java.exe"  -Xmx2048M -cp ".;%libFolder%\*;" -Dfile.encoding=UTF8 Admin_Thesaurus.OfflineToolsClass %Mode% %ThesaurusName% %InputXMLFile% %LogFilePath% 1> %SystemOutFilePath% 2>&1
