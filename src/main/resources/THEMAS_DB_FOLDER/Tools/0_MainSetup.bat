...
SET BaseNeo4jFolderPath=C:\Projects\THEMAS_DB_Folder
SET BaseTHEMASwebappPath=C:\Program Files\Apache Software Foundation\Tomcat 8.0\webapps\THEMAS
SET libFolder=C:\Program Files\Apache Software Foundation\Tomcat 8.0\lib
SET BaseInputOutpoutPath=%BaseNeo4jFolderPath%\Tools\input-output
