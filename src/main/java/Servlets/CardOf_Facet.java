    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            tmp.add(targetFacet);//tmp created just in order to reuse code that finds hierarchies of a facet set
            String xmlResults = u.getResultsInXml_Facet(SessionUserInfo,tmp , output,Q,sis_session,targetLocale,dbGen);
