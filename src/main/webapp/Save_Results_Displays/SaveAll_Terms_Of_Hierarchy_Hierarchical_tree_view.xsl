...
<xsl:stylesheet version="2.0" 
                       ...
                       <table width="100%">
                           ...
                           <tr>
                                <td colspan="2" align="left">
                                    <br/>
                                    <a>
                                        <xsl:attribute name="href"><xsl:value-of select="//typicalHierarchicalLocation"/></xsl:attribute>
                       ...
                       <xsl:choose>
                           ...
                           <xsl:otherwise>
                               ...
                               <ul class="mktree" id="tree1"  style="padding-left:0px; margin-left:0px;">
                                   <li class="liOpen" style="padding-left:0px; margin-left:0px;"> <span class="row"><b><xsl:value-of select="//topterm/name"/></b></span>
                               <ul>
    ...
    <xsl:template name="list-nts">
        ...
        <xsl:for-each select="$node[1]/nt">    
             ...
             <li class="liOpen"> <span class="row"><xsl:value-of select="."/></span>
