...
<!--
    Document   : SaveAll_Hierarchies.xsl
    Created on : 12 Οκτώβριος 2008, 3:06 μμ
    Author     : Hlias Tzortz
    Description:
        ...
        <html>
            ...
            <body style="background-color: #FFFFFF;" >
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td valign="middle">
                            <xsl:attribute name="colspan"><xsl:value-of select="count($outputVar/node())+2"/></xsl:attribute>
                            <hr/>
                        </td>
                    </tr>
                    <xsl:for-each select="//data/hierarchies/hierarchy[./name !='']">
