...
<!--
    Document   : FixData_Unclassified_HierarchyTerms.xsl
    Created on : 5 Δεκέμβριος 2008, 3:05 μμ
    Author     : tzortzak
    Description:
...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="/" >
        ...
        <xsl:variable name="localespecific" select="document($pathToSaveScriptingAndLocale)/root/fixdata/unclassifiedhierarchyterm"/>
