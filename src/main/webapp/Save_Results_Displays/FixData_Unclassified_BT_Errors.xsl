...
<!--
    Document   : Fix_Data_Unclassified_Errors.xsl
    Created on : 3 Δεκέμβριος 2008, 6:38 μμ
    Author     : tzortzak
    Description:
...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="/" >
        ...
        <xsl:variable name="localespecific" select="document($pathToSaveScriptingAndLocale)/root/fixdata/unclassifiedbts"/>
