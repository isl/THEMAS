                    ...
                    <xsl:otherwise>
                        <table width="100%" >
                            <tr>
                                ...
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/targetlink/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                                <td align="center">
                                    <strong>
                                        <xsl:value-of select="$localespecific/class/option[@lang=$lang]"/>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <td onMouseOver="this.bgColor = '#F2F2F2'" onMouseOut="this.bgColor = '#FFFFFF'" bgcolor="#FFFFFF" >
                                        <xsl:choose>
                                            <xsl:when test="contains(./category,'EnglishWord') "> 
                                                <xsl:value-of select="$localespecific/enword/option[@lang=$lang]"/>
                                            </xsl:when>
                                            <xsl:when test="contains(./category,'ItalianWord') "> 
                                                <xsl:value-of select="$localespecific/itword/option[@lang=$lang]"/>
                                            </xsl:when>
                                            <xsl:when test="contains(./category,'FrenchWord') "> 
                                                <xsl:value-of select="$localespecific/frword/option[@lang=$lang]"/>
                                            </xsl:when>
                                            ...
                                            <xsl:when test="contains(./category,'AlternativeTerm') ">
                                                <xsl:value-of select="$localespecific/alt/option[@lang=$lang]"/>
                                            </xsl:when>
