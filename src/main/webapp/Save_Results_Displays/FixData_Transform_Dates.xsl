...
<!--
    Document   : FixData_Transform_Dates.xsl
    Created on : 10 Δεκέμβριος 2008, 5:12 μμ
    Author     : tzortzak
    Description:
...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="/" >
        ...
        <xsl:variable name="localespecific" select="document($pathToSaveScriptingAndLocale)/root/fixdata/dates"/>
