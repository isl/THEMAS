...
<!--
    Document   : PagingInfo_Term_Systematic.xsl
    Created on : 11 Σεπτέμβριος 2008, 8:01 μμ
    Author     : tzortzak
    Description:
    ...
    <xsl:template name="SearchResultsPaging_Terms_Systematic">
        ...
        <xsl:if test="$pagingFirst > 1">
            ...
            <a>
                ...
                <!--<xsl:attribute name="onclick">
                    getResults('12','SearchResults_Terms_Systematic','1');
                </xsl:attribute>-->
	    ...
	    <!-- previous ARROW -->
            <a>
               <xsl:attribute name="href">
                ...
                <xsl:attribute name="onclick">DisplayPleaseWaitScreen(true);</xsl:attribute>
                <!--<xsl:attribute name="onclick">
                    getResults('12','SearchResults_Terms_Systematic',<xsl:value-of select="$pre_start"/>);
                </xsl:attribute>-->
        ...
        <xsl:if test="$pagingLast &lt; $pagingQueryResultsCount">
            ...
            <a>
                ...
                <xsl:attribute name="onclick">DisplayPleaseWaitScreen(true);</xsl:attribute>
                <!--<xsl:attribute name="onclick">
                    getResults('12','SearchResults_Terms_Systematic',<xsl:value-of select="$pagingLast + 1"/>);
                </xsl:attribute>-->
            ...
            <a>
                ...
                <!--<xsl:attribute name="onclick">
                    getResults('12','SearchResults_Terms_Systematic',<xsl:value-of select="$end_arrow_parameter"/>);
                </xsl:attribute>-->
                <xsl:attribute name="onclick">DisplayPleaseWaitScreen(true);</xsl:attribute>
