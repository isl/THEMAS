...
ThesaurusName=AATDEMO
InputXMLFile="$BaseInputOutpoutPath/Export_Thesaurus_AATDEMO_2014-03-11_18-11-31-517.xml"
LogFilePath="$BaseInputOutpoutPath/importFromXMLLog.xml"
